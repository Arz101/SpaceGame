...
CXXFLAGS = -std=c++17 -Wall -fexceptions -g -Iinclude -IManagerIncludes -I/usr/local/include/SDL2 -I/usr/local/Cellar/sdl2_image/2.8.4/include/SDL2 -I/usr/local/Cellar/sdl2_ttf/2.24.0/include
